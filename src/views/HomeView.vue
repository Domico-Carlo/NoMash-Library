        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              @input="() => detectFriendReason()"
            ></textarea>
            <div v-if="errors.reason == 'Reason must be at least 10 characters'" class="text-danger">{{ errors.reason }}</div>
            <div v-else class="text-success">{{ errors.reason }}</div>
          </div>
